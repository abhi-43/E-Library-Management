                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col img-cent">
                                <img width="100px" src="Images/generaluser.png" class="centre" />
                            </div>
                        </div>
                        <br />
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <asp:Button class="btn btn-success btn-lg col-12" ID="Button1" runat="server" Text="Sign Up" OnClick="Button1_Click" />
                                </div>
                            </div>
                        </div>
