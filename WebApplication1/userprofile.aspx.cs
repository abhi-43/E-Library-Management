    ...
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                {
                    Label3.Attributes.Add("class", "badge badge-pill bg-success");
                }
                else if (dt.Rows[0]["account_status"].ToString().Trim() == "pending")
                {
                    Label3.Attributes.Add("class", "badge badge-pill bg-warning");
                }
                else if (dt.Rows[0]["account_status"].ToString().Trim() == "deactive")
                {
                    Label3.Attributes.Add("class", "badge badge-pill bg-danger");
                }
                else
                {
                    Label3.Attributes.Add("class", "badge badge-pill bg-info");
                }
            }
            catch (Exception ex)
            {
